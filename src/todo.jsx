...
function Todo() {
  ...
  try {
    const response = await axios.get('https://todo-backend-ankitmishra.onrender.com/todos');
 ...
 const addTask = async () => {
  ...
  try {
    const response = await axios.post('https://todo-backend-ankitmishra.onrender.com/todos', newTask);
 ...
 const deleteTask = async (index) => {
    try {
      await axios.delete(`https://todo-backend-ankitmishra.onrender.com/todos/${index}`);
